...
This release includes better support for of non-credit-card payment sources, better promotion creation, and many other great changes. 

Later this month is [SolidusConf 2017 in London](http://conf.solidus.io/). Hope to see you there!
